	...
	public boolean handleMessage(Message msg) {
		switch(msg.what) {
			...
			case MSG_ACTION_CCALLBACK: {
				switch (msg.arg1) {
					case 1: {
						LogUtil.e("HandleMessage===", "成功case");
						// 成功
					...
					break;
					case 2: {
						LogUtil.e("HandleMessage===", "失败case");
						// 失败
					...
					break;
					case 3: {
						LogUtil.e("HandleMessage===", "取消case");
						// 取消
