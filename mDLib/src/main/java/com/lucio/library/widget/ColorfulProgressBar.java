...
public class ColorfulProgressBar extends View {
    ...
    private int mCpbWholeBackgroundColor = Color.parseColor("#ffffffff");
    private int mCpbBackgroundColor = Color.parseColor("#7ff0f0f0");
    private int mCpbForegroundColor = Color.parseColor("#0dfb7d");
    private int mCpbProgressTextColor;
    private int mCpbStrokeWidth = 12;// default stroke width
    ...
    private boolean mCpbIsFan = false;// default draw a circle,or be a fan
    ...
    private void parseAttributes(AttributeSet attrs) {
        ...
        mCpbIsFan = a.getBoolean(R.styleable.CircleProgressBar_cpbIsFan, mCpbIsFan);
    ...
    private void initShader() {
        ...
        if (mColorScheme != null && mColorScheme.length != 0) {
            float end = mMinWidth - mCpbStrokeWidth / 2 - 1;
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (changed) {
            ...
            int rRight = mMinWidth - mCpbStrokeWidth / 2 - 1;
            int rBottom = mMinWidth - mCpbStrokeWidth / 2 - 1;
    ...
    private void drawProgressText(Canvas canvas) {
        ...
        int textSize = (int) ((mMinWidth - mCpbStrokeWidth * 2) / 2.5 / 2);
        ...
        public void run() {
            if (mCurrentProgress >= MAX_PROGRESS) {
                ...
                if (mLoadingCallBack != null) {
                    mLoadingCallBack.loadingComplete(ColorfulProgressBar.this);
                }
            } else {
                invalidateView();
...
//        mCpbTextPaint.setShader(shader); //字体多彩渲染
    }
